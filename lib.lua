...
-- Generate hash sekali, dipakai semua gui
...
function ZuperMing:MakeNotify(NotifyConfig)
    ...
    spawn(function()
        -- [[ 1. SETUP CONTAINER ]] --
        -- NotifyGui sekarang parent ke RobloxGui, nama tetap "NotifyGui"
...
function ZuperMing:Window(GuiConfig)
    ...
    -- [[ HASH: GUI utama pakai GUI_HASH sebagai nama, parent ke RobloxGui ]] --
    ZuperMingb.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
    ZuperMingb.Name = GUI_HASH
    ZuperMingb.ResetOnSpawn = false
    ZuperMingb.Parent = RobloxGui  -- << PINDAH KE ROBLOXGUI
    ...
    function GuiFunc:DestroyGui()
        -- Cari berdasarkan hash yang tersimpan di variable GUI_HASH
    ...
    -- [[ MINIMIZE ICON ]] --
    -- ToggleUIButton parent ke RobloxGui, nama tetap
    ...
    Close.Activated:Connect(function()
        ...
        Yes.MouseButton1Click:Connect(function()
            ...
            ScriptLoaded = false
            NoclipEnabled = false
            -- Destroy semua gui yang ada di RobloxGui milik script ini
    ...
    function GuiFunc:ToggleUI()
        ...
        ScreenGui.Parent = RobloxGui  -- << PINDAH KE ROBLOXGUI
